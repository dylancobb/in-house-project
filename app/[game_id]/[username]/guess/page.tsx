...
export default function Prompt() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      const isRoundOver = await isRoundOverFunction(parseInt(urlGameID), 'player_guess')
      ...
      return (
        <main className='flex min-h-screen flex-col items-center justify-between py-10'>
          <div className='flex flex-col items-center space-y-5'>
            {turnTaken ? (
              ...
              <>
                ...
                {!pictureLoaded ? (
                  ...
                  <>
                    <Image src={drawingPrompt} alt='Drawing prompt.' width={400} height={300} />
            ...
            {roundOver ? (
            <NextRoundButton urlGameID={urlGameID} urlUsername={urlUsername} round="results" />
        ) : null}
          </div>
        </main>
      );
